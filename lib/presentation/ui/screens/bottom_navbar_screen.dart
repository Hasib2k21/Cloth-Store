        ...
        builder: (_) {
          return Scaffold(
            ...
            bottomNavigationBar: SizedBox(
              ...
              child: NavigationBar(
                backgroundColor: Colors.grey.shade100, // Set background color to white
                selectedIndex: _navbarController.selectedIndex,
                onDestinationSelected: _navbarController.changeIndex,
                labelBehavior: NavigationDestinationLabelBehavior.alwaysHide, // Hide the labels
                destinations: const [
                  NavigationDestination(icon: Icon(Icons.home), label: ''),
                  NavigationDestination(icon: Icon(Icons.notifications_outlined), label: ''),
                  NavigationDestination(icon: Icon(Icons.shopping_cart_checkout), label: ''),
